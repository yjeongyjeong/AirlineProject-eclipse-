   ...
   <div class="container" style="color: black;">
      <ul class="pagination pagination justify-content-center">
         <c:choose>
            ...
            <c:otherwise>
               <li class="page-item"><a class="page-link"
                  href="BoardServlet?command=qna_list&pageNum=${pageVO.pageNum - 1 }&amount=${pageVO.amount}">Previous</a></li>
            </c:otherwise>
         </c:choose>
         <c:forEach var="num" begin="${pageVO.startPage }"
            ...
            <li class="page-item" style="color: black;"><a
               class="page-link"
               href="BoardServlet?command=qna_list&pageNum=${num }&amount=${pageVO.amount}">${num }</a></li>
         </c:forEach>
         <c:choose>
            ...
            <c:otherwise>
               <li class="page-item"><a class="page-link"
                  href="BoardServlet?command=qna_list&pageNum=${pageVO.pageNum + 1 }&amount=${pageVO.amount}">Next</a></li>
