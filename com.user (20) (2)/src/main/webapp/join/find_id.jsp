...
<br><br><hr><br>
							...
							<form name="signUpForm" action="UserServlet" method="post"
								...
								<table 
									...
									<tr>
										<th style="padding: 8px; border-top: none; text-align: center; vertical-align: middle; width: 150px">이메일</th>
										<td style="border-top: none; padding: 0"><input type="text" name="email" id="inputEmailForm"
											maxlength="30" class="form-control" style="display: inline; width: 250px">
											<button onclick="emailAuthentication()" id="eamilAuthBtn"
												type="button" class="btn btn-primary" style="display: inline;">인증 메일 보내기</button></td>
									</tr>
								...
								<br>
								<button
									onclick="location.href='UserServlet?command=show_userid'"
