		...
		<form action="UserServlet" name="frm" method="post">
			...
			<table
				...
				<tbody>
					...
					<tr>
							<th scope="row" style="padding: 16px 8px 8px 8px; width: 150px"><label for="pwd">비밀번호<span
									class="icon_require" style="color: red; font-size: x-small;">
										*</span></label></th>
						...
						<tr>
							<th scope="row" style="padding: 16px 8px 8px 8px; width: 150px"><label for="pwd_check">비밀번호 확인<span
									class="icon_require" style="color: red; font-size: x-small;">
										*</span></label></th>
